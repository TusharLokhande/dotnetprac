#pragma checksum "C:\Users\tlokh\OneDrive\Desktop\Project\WOW_proj\Prosares.Wow.Login\Views\ChangePassword\ChangePassword.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6bdd9c465a74e83347a8502fc9e3eed610bdef9d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6bdd9c465a74e83347a8502fc9e3eed610bdef9d", @"/Views/ChangePassword/ChangePassword.cshtml")]
...
<style>
    ...
    .toast-header {
        ba");
            WriteLiteral(@"ckground-color: cornflowerblue;
    }
</style>
...
");
#nullable restore
#line 96 "C:\Users\tlokh\OneDrive\Desktop\Project\WOW_proj\Prosares.Wow.Login\Views\ChangePassword\ChangePassword.cshtml"
                 if (Model.FirstLogin == false)
                {
...
");
#nullable restore
#line 103 "C:\Users\tlokh\OneDrive\Desktop\Project\WOW_proj\Prosares.Wow.Login\Views\ChangePassword\ChangePassword.cshtml"
                }
...
<script>
    $(document).ready(()=>{
      ...
      // $('.pass_show').append('<span> <i class=""fa fa-eye-slash ptxt""  aria-hidden=""true""></i></span>');  
        ...
        ");
            WriteLiteral(@"            $('#showPass_2').addClass('fa fa-eye-slash ptxt');
                }
            });
...
");
    ...
    $(""#submit"").click(() => {
        ...
        if (current != """" || current != null) {
            data.CurrentPassword = cu");
            WriteLiteral(@"rrent;
            console.log(data);
            let x = CheckCurrentPassword(data)
            console.log(""Check Password: "",x);
            if(x == 'false' || x == false){
                return;
            }
        }
