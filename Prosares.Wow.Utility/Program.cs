...
using Prosares.Wow.Utility.Services.EmployeeDiscripency;
...
namespace Prosares.Wow.Utility
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            EmployeeDiscripency  emp = Host.Services.GetService<EmployeeDiscripency>();
            emp.Process();
        }
        ...
        static IHostBuilder CreateHostBuilder(string[] args)
        {
            return Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    services.AddScoped<IEmployeeDiscripency, EmployeeDiscripency>();
                })
