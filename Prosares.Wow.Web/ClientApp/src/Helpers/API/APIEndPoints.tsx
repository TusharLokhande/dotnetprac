...
export const GetMileStoneReportData = `${url}/api/milestonereport/GetMileStoneReportData`;

export const MileStoneReportExportToExcel = `${url}/api/milestonereport/MileStoneExportToExcel`;
