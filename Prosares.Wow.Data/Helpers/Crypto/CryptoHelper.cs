...
namespace Prosares.Wow.Data.Helpers.Crypto
{
    public class CryptoHelper
    {
        private static readonly int iterations = 100;
        private static readonly string key = "ENapaxaWvMMiaBKk";
        //private readonly IOptions<ConfigModel> _ConfigModel;

        //public CryptoHelper(IOptions<ConfigModel> ConfigModel)
        //{
        //    _ConfigModel = ConfigModel;
        //    iterations = Convert.ToInt32(_ConfigModel.Value.IterationsKey);
        //    key = _ConfigModel.Value.EncryptionKey;
        //}
